...
{ "UI_QUADRANT_LOCKED_TAP",  new[] { "Desbloquea en Piso {0}", "Unlocks at Floor {0}", "フロア{0}で解放" } },
        ...
        { "UI_ARCHIVE_HINT",       new[] { "Registro de hitos y crónicas de la Torre", "Log of milestones and Tower lore",
                                              "塔の記録と昇格の歴史" } },
        { "UI_PROD_ARCHIVE",       new[] { "+{0} moral cada {1}s a la base (hasta {2})",
                                              "+{0} morale every {1}s to the base (up to {2})",
                                              "{1}秒ごとに拠点へ士気+{0}（上限{2}）" } },
        ...
        { "Q_AWAKEN",        new[] { "Chispa Latente: despierta {0} habilidad(es) nueva(s).", "Latent Spark: awaken {0} new skill(s).", "眠れる火花：新たな技を{0}つ覚醒させよ。" } },
        { "Q_NOLOSS",        new[] { "Sin una Baja: despeja {0} piso(s) sin perder a nadie.", "Not One Lost: clear {0} floor(s) without losing anyone.", "犠牲なし：誰も失わずに{0}階層を制圧せよ。" } },
        { "Q_CHALLENGE",     new[] { "Letra Pequeña: cumple {0} reto(s) oculto(s).", "Fine Print: complete {0} hidden challenge(s).", "細則：隠し試練を{0}回達成せよ。" } },
        { "Q_POTION",        new[] { "Estantes Llenos: fabrica {0} poción(es).", "Full Shelves: brew {0} potion(s).", "満ちた棚：薬を{0}個調合せよ。" } },
        { "Q_HARVEST",       new[] { "Despensa: cosecha {0} de comida.", "Larder: harvest {0} food.", "食料庫：食料を{0}収穫せよ。" } },
        { "Q_BOND",          new[] { "Hombro con Hombro: forja {0} vínculo(s) entre héroes.", "Shoulder to Shoulder: forge {0} bond(s) between heroes.", "肩を並べて：英雄同士の絆を{0}つ結べ。" } },
